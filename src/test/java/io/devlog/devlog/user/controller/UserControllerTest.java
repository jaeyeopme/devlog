...
import static io.devlog.devlog.fixture.UserFixture.NEW_USER;
...
class UserControllerTest {
    ...
    void registration_Success_201() throws Exception {
        doNothing().when(userService).register(NEW_USER);

        this.mockMvc.perform(post(USER_API_URI)
    ...
    void memberRegistration_Fail_409_ErrorMessage() throws Exception {
        when(userService.isDuplicatedEmail(NEW_USER.getEmail())).thenReturn(true);
